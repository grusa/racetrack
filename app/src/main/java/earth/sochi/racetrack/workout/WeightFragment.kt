...
import earth.sochi.racetrack.databinding.FragmentWeightBinding
import earth.sochi.racetrack.viewmodels.WeightViewModel
...
//    public var weightList: List<Weight> = listOf()
    ...
    fun deleteWeight(id:Long) {
        ...
        val w = Weight(1,1,1,1)
        weightViewModel.insertWeight(w)
